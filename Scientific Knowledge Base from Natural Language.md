...
### Summary: 
The experiment done by Tshitoyan et al. (2019), the substantial power that word embeddings could have in uncovering latent scientific knowledge over expansive literature was demonstrated. In their work, they discussed the possibility of future work utilizing more powerful models such as BERT, which is both more powerful, and may be able to exploit the full text of the articles rather than just the abstract. This leaves some very low hanging fruit for initial research with just the substitution of one model for another, with the possible addition of more data. But we can go further.
